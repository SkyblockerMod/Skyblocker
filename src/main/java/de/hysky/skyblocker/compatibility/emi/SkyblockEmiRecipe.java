...
public class SkyblockEmiRecipe implements EmiRecipe {
	...
	public void addWidgets(WidgetHolder widgets) {
		...
		widgets.addDrawable(0, 0, getDisplayWidth(), getDisplayHeight(), (draw, mouseX, mouseY, delta) -> recipe.extractRenderState(draw, getDisplayWidth(), getDisplayHeight(), mouseX, mouseY));
	}
}
