...
public class DisableAll {
    ...
    /**
     * Recursively sets all boolean {@link dev.isxander.yacl3.config.v2.api.SerialEntry}
     * fields within our configuration classes to {@code false}.
     */
    private static void disableBooleans(Object target) throws IllegalAccessException {
        for (Field field : target.getClass().getDeclaredFields()) {
            if (!field.isAnnotationPresent(dev.isxander.yacl3.config.v2.api.SerialEntry.class)) continue;
