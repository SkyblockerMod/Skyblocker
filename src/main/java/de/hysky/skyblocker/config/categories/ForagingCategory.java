				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.translatable(
										"skyblocker.config.foraging.galatea.solveForestTemplePuzzle.@Tooltip")))
						...
						.option(Option.<Boolean>createBuilder()
								.name(Text
										.translatable("skyblocker.config.foraging.galatea.enableLushlilacHighlighter"))
								.description(OptionDescription.of(Text.translatable(
										"skyblocker.config.foraging.galatea.enableLushlilacHighlighter.@Tooltip")))
						...
						.option(Option.<Float>createBuilder()
								.name(Text
										.translatable("skyblocker.config.foraging.galatea.lushlilacHighlighterOpacity"))
								.description(OptionDescription.of(Text.translatable(
										"skyblocker.config.foraging.galatea.lushlilacHighlighterOpacity.@Tooltip")))
						...
						.option(Option.<Boolean>createBuilder()
								.name(Text
										.translatable("skyblocker.config.foraging.galatea.enableSeaLumiesHighlighter"))
								.description(OptionDescription.of(Text.translatable(
										"skyblocker.config.foraging.galatea.enableSeaLumiesHighlighter.@Tooltip")))
						...
						.option(Option.<Float>createBuilder()
								.name(Text
										.translatable("skyblocker.config.foraging.galatea.seaLumiesHighlighterOpacity"))
								.description(OptionDescription.of(Text.translatable(
										"skyblocker.config.foraging.galatea.seaLumiesHighlighterOpacity.@Tooltip")))
						...
						.option(Option.<Boolean>createBuilder()
								...
								.description(OptionDescription.of(Text.translatable(
										"skyblocker.config.foraging.galatea.enableTreeBreakProgress.@Tooltip")))
						...
						.option(ButtonOption.createBuilder()
								...
								.action((screen, opt) -> MinecraftClient.getInstance()
										.setScreen(new WidgetsConfigurationScreen(Location.GALATEA,
												TreeBreakProgressHud.getInstance().getInternalID(), screen)))
								.build())
						.option(Option.<Integer>createBuilder()
								.name(Text.translatable("skyblocker.config.foraging.galatea.seaLumieMinCount"))
								.description(OptionDescription.of(Text
										.translatable("skyblocker.config.foraging.galatea.seaLumieMinCount.@Tooltip")))
