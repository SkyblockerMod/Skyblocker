...
public class UIAndVisualsCategory {
		public static ConfigCategory create(SkyblockerConfig defaults, SkyblockerConfig config) {
				return ConfigCategory.createBuilder()
								...
								//Tab Chat
								.group(OptionGroup.createBuilder()
												.name(Component.translatable("skyblocker.config.uiAndVisuals.tabChat"))
												.description(Component.translatable("skyblocker.config.uiAndVisuals.tabChat.@Tooltip"))
												.option(Option.<Boolean>createBuilder()
																.name(Component.translatable("skyblocker.config.uiAndVisuals.tabChat.enableTabChat"))
																.description(Component.translatable("skyblocker.config.uiAndVisuals.tabChat.enableTabChat.@Tooltip"))
																.binding(defaults.uiAndVisuals.tabChat.enableTabChat,
																				() -> config.uiAndVisuals.tabChat.enableTabChat,
																				newValue -> config.uiAndVisuals.tabChat.enableTabChat = newValue)
																.controller(ConfigUtils.createBooleanController())
																.build())
												.option(ButtonOption.createBuilder()
																.name(Component.translatable("skyblocker.config.uiAndVisuals.tabChat.positionConfig"))
																.prompt(Component.translatable("skyblocker.config.uiAndVisuals.tabChat.positionConfig.open"))
																.action(screen -> Minecraft.getInstance().setScreen(new de.hysky.skyblocker.skyblock.tabchat.TabChatPositionScreen()))
																.build())
												.build()
								)
								.build();
