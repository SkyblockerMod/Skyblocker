...
import de.hysky.skyblocker.skyblock.slayers.partycounter.PartyCounterWidgetScreen;
...
public class SlayersCategory {
		...
		public static ConfigCategory create(SkyblockerConfig defaults, SkyblockerConfig config) {
				return ConfigCategory.createBuilder()
								...
								.group(OptionGroup.createBuilder()
												.name(Component.translatable("skyblocker.config.slayer.partySlayerCounter"))
												.collapsed(true)
												.option(Option.<Boolean>createBuilder()
																.name(Component.translatable("skyblocker.config.slayer.partySlayerCounter.enable"))
																.description(Component.translatable("skyblocker.config.slayer.partySlayerCounter.enable.@Tooltip"))
																.binding(defaults.slayers.partySlayerCounter.enablePartyCounter,
																				() -> config.slayers.partySlayerCounter.enablePartyCounter,
																				newValue -> config.slayers.partySlayerCounter.enablePartyCounter = newValue)
																.controller(ConfigUtils.createBooleanController())
																.build())
												.option(Option.<CounterMode>createBuilder()
																.name(Component.translatable("skyblocker.config.slayer.partySlayerCounter.counterMode"))
																.description(Component.translatable("skyblocker.config.slayer.partySlayerCounter.counterMode.@Tooltip"))
																.binding(defaults.slayers.partySlayerCounter.counterMode,
																				() -> config.slayers.partySlayerCounter.counterMode,
																				newValue -> config.slayers.partySlayerCounter.counterMode = newValue)
																.controller(ConfigUtils.createEnumController())
																.build())
												.option(Option.<Boolean>createBuilder()
																.name(Component.translatable("skyblocker.config.slayer.partySlayerCounter.showWidget"))
																.description(Component.translatable("skyblocker.config.slayer.partySlayerCounter.showWidget.@Tooltip"))
																.binding(defaults.slayers.partySlayerCounter.showWidget,
																				() -> config.slayers.partySlayerCounter.showWidget,
																				newValue -> config.slayers.partySlayerCounter.showWidget = newValue)
																.controller(ConfigUtils.createBooleanController())
																.build())
												.option(ButtonOption.createBuilder()
																.name(Component.translatable("skyblocker.config.slayer.partySlayerCounter.widgetPosition"))
																.prompt(Component.translatable("text.skyblocker.open"))
																.action(screen -> Minecraft.getInstance().setScreen(new PartyCounterWidgetScreen(screen)))
																.build())
												.build())
