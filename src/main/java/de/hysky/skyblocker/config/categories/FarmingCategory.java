		...
		return ConfigCategory.createBuilder()
				...
				.group(OptionGroup.createBuilder()
						...
						.option(Option.<Boolean>createBuilder()
								...
								.build())
						.option(ButtonOption.createBuilder()
								.name(Component.literal("Greenhouse Plot Presets"))
								.prompt(Component.literal("Edit Presets"))
								.description(Component.literal("Save SkyMutations links as presets. Paste a preset with '/skyblocker garden greenhouse paste <preset>'."))
