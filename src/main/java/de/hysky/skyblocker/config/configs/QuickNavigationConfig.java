...
public class QuickNavigationConfig {
	 ...
	 */
	public QuickNavItem button4 = new QuickNavItem(false, new ItemData(Items.LEATHER_CHESTPLATE, "[minecraft:dyed_color=8991416]"), "\\(\\d+/\\d+\\) Armor Sets", "/wardrobe", "Wardrobe");
