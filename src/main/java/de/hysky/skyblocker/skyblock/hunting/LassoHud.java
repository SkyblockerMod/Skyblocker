...
public class LassoHud extends ElementBasedWidget {
	...
	public LassoHud() {
		super(Component.literal("Lasso").withStyle(ChatFormatting.DARK_AQUA, ChatFormatting.BOLD), ChatFormatting.DARK_AQUA.getColor(), new Information("hud_lasso", Component.literal("Lasso HUD"), Location.GALATEA, Location.TORRHUS_CANYON));
		instance = this;
	}
