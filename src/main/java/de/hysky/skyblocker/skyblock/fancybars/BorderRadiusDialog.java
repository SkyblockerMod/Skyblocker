...
public class BorderRadiusDialog extends Screen {
		...
		private FilteredEditBox inputBox;
		...
		protected void init() {
				...
				inputBox = new FilteredEditBox(font, cx - 50, cy - 10, 100, 20,
		...
		public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
				...
				// Title
				context.centeredText(font, getTitle(), cx, cy - panelH / 2 + 5, 0xFFFFFF);
				...
				if (!errorMsg.getString().isEmpty()) {
						context.centeredText(font, errorMsg, cx, cy + 36, 0xFF5555);
				}
