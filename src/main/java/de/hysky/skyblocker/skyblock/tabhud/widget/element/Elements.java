...
public class Elements {
	...
	public static Element iconTextComponent(@Nullable ItemStack icon, @Nullable Component text) {
	...
	public static Element iconFatTextComponent(@Nullable ItemStack icon, @Nullable Component line1, @Nullable Component line2) {
		if (SkyblockerConfigManager.get().uiAndVisuals.tabHud.displayIcons) {
	 ...
	 */
	public static Element progressComponent(ItemStack icon, Component description, @Range(from = 0, to = 100) float percent) {
		return switch (SkyblockerConfigManager.get().uiAndVisuals.tabHud.style) {
	 ...
	 * @param percent the percentage from 0 to 100
	 */
	public static Element progressComponent(ItemStack icon, Component description, @Range(from = 0, to = 100) float percent, int color) {
		return switch (SkyblockerConfigManager.get().uiAndVisuals.tabHud.style) {
	 ...
	 * @param percent the percentage from 0 to 100
	 */
	public static Element progressComponent(ItemStack icon, Component description, Component bar, @Range(from = 0, to = 100) float percent) {
		return switch (SkyblockerConfigManager.get().uiAndVisuals.tabHud.style) {
	 ...
	 * @param percent the percentage from 0 to 100
	 */
	public static Element progressComponent(ItemStack icon, Component description, Component bar, @Range(from = 0, to = 100) float percent, int color) {
		return switch (SkyblockerConfigManager.get().uiAndVisuals.tabHud.style) {
