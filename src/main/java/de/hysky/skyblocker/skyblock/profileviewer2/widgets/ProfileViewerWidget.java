 ...
 */
public abstract sealed class ProfileViewerWidget extends AbstractWidget permits BasicInfoBoxWidget, LevelBarWidget, PageTabWidget, PlayerWidget, RulerWidget, TestTextWidget, InventoryWidget {
	/**
