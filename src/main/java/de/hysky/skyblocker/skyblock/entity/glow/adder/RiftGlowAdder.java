...
public class RiftGlowAdder extends MobGlowAdder {
	...
	public int computeColour(Entity entity) {
		return entity instanceof Player p && SkyblockerConfigManager.get().otherLocations.rift.blobbercystGlow && p.getName().getString().equals("Blobbercyst ") ? TextColor.GREEN.getValue() : NO_GLOW;
	}
