...
public final class PowderMiningTracker extends AbstractProfitTracker {
	...
	private final Object2IntAVLTreeMap<Component> shownRewards = new Object2IntAVLTreeMap<>(Comparator.<net.minecraft.network.chat.Component>comparingInt(text -> comparePriority(text.getString())).thenComparing((c) -> c.getString()));
