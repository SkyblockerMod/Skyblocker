...
public class MuseumManager extends AbstractWidget implements HoveredItemStackProvider {
	...
	private final StateSwitchingButton nextPageButton;
	private final StateSwitchingButton prevPageButton;
	...
	public MuseumManager(Screen screen, int x, int y, int backgroundWidth) {
		...
		this.nextPageButton = new StateSwitchingButton(getX() + 93, getY() + 133, 12, 17, false);
		this.nextPageButton.initTextureValues(RecipeBookPage.PAGE_FORWARD_SPRITES);
		this.prevPageButton = new StateSwitchingButton(getX() + 38, getY() + 133, 12, 17, true);
