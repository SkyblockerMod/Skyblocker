...
public class ChatRuleConfigScreen extends Screen {
	...
	protected void init() {
		...
		DirectionalLayoutWidget filtersRow1 = contentAdder.add(DirectionalLayoutWidget.horizontal().spacing(GRID_SPACING), 3);
								...
								.build(0, 0, getWidth(1.5f), 20, Text.translatable("skyblocker.config.chat.chatRules.screen.ruleScreen.ignoreCase"), (button, value) ->
										chatRule.setIgnoreCase(value)));
		...
		toastMessageInput.setRenderTextProvider(createRenderTextProvider(toastMessageInput::getText));
