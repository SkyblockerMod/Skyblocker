...
public class PaginationButton extends ClickableWidget {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        context.drawTexture(RenderLayer::getGuiTextured, TEXTURE, this.getX(), this.getY(), 0, 0, 12, 17, 12, 17);
        if (isMouseOver(mouseX, mouseY)) context.drawTexture(RenderLayer::getGuiTextured, HIGHLIGHT, this.getX(), this.getY(), 0, 0, 12, 17, 12, 17);
    }
