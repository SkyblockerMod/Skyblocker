...
public record DungeonRoomSecretCountMessage(String type, UUID uuid, String roomName, int secretCount) implements Message<DungeonRoomSecretCountMessage> {
	...
	public static final Codec<DungeonRoomSecretCountMessage> CODEC = RecordCodecBuilder.create(instance -> instance.group(
					...
					Uuids.STRING_CODEC.fieldOf("uuid").forGetter(DungeonRoomSecretCountMessage::uuid),
