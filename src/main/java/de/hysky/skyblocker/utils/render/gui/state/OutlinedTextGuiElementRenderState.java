...
public class OutlinedTextGuiElementRenderState extends GuiTextRenderState {
	...
	private PreparedText prepareOutline() {
		...
		Font.PreparedTextBuilder drawer = this.font.new PreparedTextBuilder(0.0f, 0.0f, this.outlineColor, false);
	...
	private PreparedText prepareText() {
		PreparedText textPreparation = this.font.prepareText(this.text, (float) this.x, (float) this.y, this.color, this.dropShadow, this.backgroundColor);
