...
public class HudHelper {
	...
	public static void renderNineSliceColored(GuiGraphics graphics, Identifier texture, int x, int y, int width, int height, int argb) {
		graphics.blitSprite(RenderPipelines.GUI_TEXTURED, texture, x, y, width, height, argb);
	}

	public static void renderNineSliceColored(GuiGraphics graphics, Identifier texture, int x, int y, int width, int height, Color color) {
	...
	public static void drawHorizontalGradient(GuiGraphics graphics, float startX, float startY, float endX, float endY, int colorStart, int colorEnd) {
	 ...
	 */
	public static void drawCustomShape(GuiGraphics graphics, List<Vector2f> vertices, int color) {
	...
	public static <S> void drawEquipment(GuiGraphics graphics, EquipmentLayerRenderer equipmentRenderer, EquipmentClientInfo.LayerType layerType, ResourceKey<EquipmentAsset> assetKey, Model<S> model, S state, ItemStack stack, int x1, int y1, int x2, int y2, float rotation, float scale, float offset) {
	...
	public static void drawOutlinedText(GuiGraphics graphics, Component text, int x, int y, int color, int outlineColor) {
	...
	public static void drawOutlinedText(GuiGraphics graphics, FormattedCharSequence text, int x, int y, int color, int outlineColor) {
		drawOutlinedText(graphics, text, text, x, y, color, outlineColor);
	}

	private static void drawOutlinedText(GuiGraphics graphics, FormattedCharSequence text, FormattedCharSequence outlineText, int x, int y, int color, int outlineColor) {
