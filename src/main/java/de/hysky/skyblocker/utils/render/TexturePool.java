 ...
 */
public record TexturePool(String name, int size, int usage, TextureFormat format, @Nullable GpuTexture[] textures, @Nullable GpuTextureView[] textureViews, boolean[] usedSlots) implements AutoCloseable {
	 ...
	 */
	public static TexturePool create(String name, int size, int usage, TextureFormat format) {
