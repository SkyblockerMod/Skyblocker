...
public class WaypointGroupTest {
    ...
    void testCodecEncode() {
        WaypointGroup group = new WaypointGroup("group", "hub", List.of(new NamedWaypoint(BlockPos.ORIGIN, "waypoint", new float[]{0f, 0.5f, 1f}, false), new NamedWaypoint(new BlockPos(-1, 0, 1), "waypoint", new float[]{0f, 0f, 0f}, true)));
    ...
    void testCodecDecode() {
        ...
        WaypointGroup expectedGroup = new WaypointGroup("group", "hub", List.of(new NamedWaypoint(BlockPos.ORIGIN, "waypoint", new float[]{0f, 0.5f, 1f}, false), new NamedWaypoint(new BlockPos(-1, 0, 1), "waypoint", new float[]{0f, 0f, 0f}, true)));
