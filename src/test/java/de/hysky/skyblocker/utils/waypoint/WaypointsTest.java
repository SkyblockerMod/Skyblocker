...
public class WaypointsTest {
    ...
    void testFromColeweightJson() {
        ...
        WaypointCategory waypointCategory = Waypoints.fromColeweightJson(coleweightJson, "winter");
        WaypointCategory expectedWaypointCategory = new WaypointCategory("Coleweight", "winter", List.of(
        ...
        Assertions.assertEquals(expectedWaypointCategory.waypoints().size(), waypointCategory.waypoints().size());
        for (int i = 0; i < waypointCategory.waypoints().size(); i++) {
            Assertions.assertEquals(expectedWaypointCategory.waypoints().get(i), waypointCategory.waypoints().get(i));
        }
        Assertions.assertEquals(expectedWaypointCategory.name(), waypointCategory.name());
        Assertions.assertEquals(expectedWaypointCategory.island(), waypointCategory.island());
        Assertions.assertEquals(expectedWaypointCategory.ordered(), waypointCategory.ordered());
        Assertions.assertEquals(expectedWaypointCategory, waypointCategory);
    }
    ...
    void testFromColeweightJsonSapphire() {
        ...
        WaypointCategory waypointCategory = Waypoints.fromColeweightJson(coleweightJson, "crystal_hollows");
        WaypointCategory expectedWaypointCategory = new WaypointCategory("Coleweight", "crystal_hollows", List.of(
