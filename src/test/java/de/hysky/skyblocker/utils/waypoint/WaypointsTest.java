...
public class WaypointsTest {
    ...
    void testFromSkytilsBase64() {
        ...
        List<WaypointGroup> waypointGroups = Waypoints.fromSkytils(waypointGroupsSkytilsBase64, "");
        List<WaypointGroup> expectedWaypointGroups = List.of(new WaypointGroup("category", "hub", List.of(new NamedWaypoint(BlockPos.ORIGIN, "waypoint", new float[]{0f, 0.5019608f, 1f}, 0.8f, false), new NamedWaypoint(new BlockPos(-1, 0, 1), "1", new float[]{0f, 0f, 0f}, true))));
    ...
    void testToSkytilsBase64() {
        List<WaypointGroup> waypointGroups = List.of(new WaypointGroup("category", "hub", List.of(new NamedWaypoint(BlockPos.ORIGIN, "waypoint", new float[]{0f, 0.5f, 1f}, 0.8f, false), new NamedWaypoint(new BlockPos(-1, 0, 1), "1", new float[]{0f, 0f, 0f}, true))));
    ...
    void testFromSkytilsBase64GlacialCaveWaypoints() {
        ...
        List<WaypointGroup> waypointGroups = Waypoints.fromSkytils(waypointGroupsSkytilsBase64, "");
        List<WaypointGroup> expectedWaypointGroups = List.of(new WaypointGroup("Frozen Treasure Locations", "winter", List.of(
    ...
    void testFromSkytilsBase64CrystalHollowsWaypoints() {
        ...
        List<WaypointGroup> waypointGroups = Waypoints.fromSkytils(waypointsSkytilsBase64, "crystal_hollows");
        List<WaypointGroup> expectedWaypointGroups = List.of(new WaypointGroup("New Group", "crystal_hollows", List.of(
    ...
    void testFromSkytilsV1Gzip() {
        ...
        List<WaypointGroup> waypointGroups = Waypoints.fromSkytils(waypointsSkytilsV1Gzip, "default_island");
        List<WaypointGroup> expectedWaypointGroups = List.of(new WaypointGroup("Supply Safe Spots", "default_island", List.of(
        ...
        )), new WaypointGroup("Fuel Cell Safe Spots", "default_island", List.of(
    ...
    void testFromColeweightJson() {
        ...
        WaypointGroup waypointGroup = Waypoints.fromColeweightJson(coleweightJson, "winter");
        WaypointGroup expectedWaypointGroup = new WaypointGroup("Coleweight", "winter", List.of(
        ...
        Assertions.assertEquals(expectedWaypointGroup.waypoints().size(), waypointGroup.waypoints().size());
        for (int i = 0; i < waypointGroup.waypoints().size(); i++) {
            Assertions.assertEquals(expectedWaypointGroup.waypoints().get(i), waypointGroup.waypoints().get(i));
        }
        Assertions.assertEquals(expectedWaypointGroup.name(), waypointGroup.name());
        Assertions.assertEquals(expectedWaypointGroup.island(), waypointGroup.island());
        Assertions.assertEquals(expectedWaypointGroup.ordered(), waypointGroup.ordered());
    ...
    void testFromColeweightJsonSapphire() {
        ...
        WaypointGroup waypointGroup = Waypoints.fromColeweightJson(coleweightJson, "crystal_hollows");
        WaypointGroup expectedWaypointGroup = new WaypointGroup("Coleweight", "crystal_hollows", List.of(
