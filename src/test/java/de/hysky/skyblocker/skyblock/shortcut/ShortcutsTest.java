...
public class ShortcutsTest {
	...
	void testShortcutsParse() {
		Shortcuts.ShortcutsRecord expected = new Shortcuts.ShortcutsRecord(Object2ObjectMaps.singleton("/s", "/skyblock"), Object2ObjectMaps.singleton("/pa", "/p accept"), Object2ObjectMaps.singleton(new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_K, -1))), "/skyblock"));
	...
	void testShortcutsParseKeyCombo() {
		Shortcuts.ShortcutsRecord expected = new Shortcuts.ShortcutsRecord(Object2ObjectMaps.singleton("/s", "/skyblock"), Object2ObjectMaps.singleton("/pa", "/p accept"), new Object2ObjectOpenHashMap<>(Map.of(new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_S, -1), fromKeyCode(InputConstants.KEY_K, -1))), "/skyblock", new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_P, -1), fromKeyCode(InputConstants.KEY_V, -1))), "/pv")));
	...
	void testShortcutsEncode() {
		Shortcuts.ShortcutsRecord shortcuts = new Shortcuts.ShortcutsRecord(Object2ObjectMaps.singleton("/s", "/skyblock"), Object2ObjectMaps.singleton("/pa", "/p accept"), Object2ObjectMaps.singleton(new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_K, -1))), "/skyblock"));
	...
	void testShortcutsEncodeKeyCombo() {
		Shortcuts.ShortcutsRecord shortcuts = new Shortcuts.ShortcutsRecord(Object2ObjectMaps.singleton("/s", "/skyblock"), Object2ObjectMaps.singleton("/pa", "/p accept"), new Object2ObjectOpenHashMap<>(Map.of(new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_S, -1), fromKeyCode(InputConstants.KEY_K, -1))), "/skyblock", new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_P, -1), fromKeyCode(InputConstants.KEY_V, -1))), "/pv")));
	...
	void testShortcutsModify() {
		...
		shortcuts.keyBindings().put(new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_S, -1), fromKeyCode(InputConstants.KEY_K, -1))), "/skyblock");
		shortcuts.keyBindings().put(new ShortcutKeyBinding(List.of(fromKeyCode(InputConstants.KEY_P, -1), fromKeyCode(InputConstants.KEY_V, -1))), "/pv");
		JsonElement shortcutsJson = Shortcuts.ShortcutsRecord.CODEC.encodeStart(JsonOps.INSTANCE, shortcuts).getOrThrow();
